        ...
        <div class="header">
            ...
            <div class="header-left active">
                <a href="{{ route('admin#dashboard') }}" class="logo">
                    <img src="{{ asset('storage/admin/img/logo.png') }}" alt="">
                </a>
                <a href="{{ route('admin#dashboard') }}" class="logo-small">
                    <img src="{{ asset('storage/admin/img/logo-small.png') }}" alt="">
                </a>
            ...
            <ul class="nav user-menu">
                        ...
                        <form action="#">
                            <div class="searchinputs">
                                ...
                                <div class="search-addon">
                                    <span><img src="{{ asset('storage/admin/img/icons/closes.svg') }}"
                                            alt="img"></span>
                                </div>
                            </div>
                            <a class="btn" id="searchdiv"><img
                                    src="{{ asset('storage/admin/img/icons/search.svg') }}" alt="img"></a>
                        </form>
                    </div>
                </li>
                ...
                <li class="nav-item dropdown has-arrow flag-nav">
                    <a class="nav-link dropdown-toggle" data-bs-toggle="dropdown" href="javascript:void(0);"
                        role="button">
                        <img src="{{ asset('storage/admin/img/flags/us1.png') }}" alt="" height="20">
                    </a>
                    <div class="dropdown-menu dropdown-menu-right">
                        <a href="javascript:void(0);" class="dropdown-item">
                            <img src="{{ asset('storage/admin/img/flags/us.png') }}" alt="" height="16">
                            English
                        </a>
                        <a href="javascript:void(0);" class="dropdown-item">
                            <img src="{{ asset('storage/admin/img/flags/fr.png') }}" alt="" height="16">
                            French
                        </a>
                        <a href="javascript:void(0);" class="dropdown-item">
                            <img src="{{ asset('storage/admin/img/flags/es.png') }}" alt="" height="16">
                            Spanish
                        </a>
                        <a href="javascript:void(0);" class="dropdown-item">
                            <img src="{{ asset('storage/admin/img/flags/de.png') }}" alt="" height="16">
                            German
                        </a>
                    </div>
                </li> --}}
                ...
                {{-- <li class="nav-item dropdown">
                    <a href="javascript:void(0);" class="dropdown-toggle nav-link" data-bs-toggle="dropdown">
                        <img src="{{ asset('storage/admin/img/icons/notification-bing.svg') }}" alt="img"> <span
                                    ...
                                    <a href="activities.html">
                                        <div class="media d-flex">
                                            <span class="avatar flex-shrink-0">
                                                <img alt=""
                                                    src="{{ asset('storage/admin/img/profiles/avatar-02.jpg') }}">
                                            </span>
                                ...
                                <li class="notification-message">
                                    <a href="activities.html">
                                        <div class="media d-flex">
                                            <span class="avatar flex-shrink-0">
                                                <img alt=""
                                                    src="{{ asset('storage/admin/img/profiles/avatar-03.jpg') }}">
                                            </span>
                                            <div class="media-body flex-grow-1">
                                ...
                                <li class="notification-message">
                                    <a href="activities.html">
                                        <div class="media d-flex">
                                            <span class="avatar flex-shrink-0">
                                                <img alt=""
                                                    src="{{ asset('storage/admin/img/profiles/avatar-06.jpg') }}">
                                            </span>
                                            <div class="media-body flex-grow-1">
                                ...
                                <li class="notification-message">
                                    <a href="activities.html">
                                        <div class="media d-flex">
                                            <span class="avatar flex-shrink-0">
                                                <img alt=""
                                                    src="{{ asset('storage/admin/img/profiles/avatar-17.jpg') }}">
                                            </span>
                                            <div class="media-body flex-grow-1">
                                ...
                                <li class="notification-message">
                                    <a href="activities.html">
                                        <div class="media d-flex">
                                            <span class="avatar flex-shrink-0">
                                                <img alt=""
                                                    src="{{ asset('storage/admin/img/profiles/avatar-13.jpg') }}">
                                            </span>
                                            <div class="media-body flex-grow-1">
                        ...
                        <div class="profilename">
                            ...
                            <form action="{{ route('logout') }}" method="POST">
                                ...
                                <button class="dropdown-item logout pb-0"><img
                                    src="{{ asset('storage/admin/img/icons/log-out.svg') }}" class="me-2"
                    ...
                    <ul>
                        <li class="active">
                            <a href="{{ route('admin#dashboard') }}"><img
                                    src="{{ asset('storage/admin/img/icons/dashboard.svg') }}" alt="img">
                                <span>Dashboard</span>
                            </a>
                        </li>
                        <li class="submenu">
                            <a href="javascript:void(0);"><img
                                    src="{{ asset('storage/admin/img/icons/product.svg') }}" alt="img"><span>
